 ...
 *
 */
public class CheckSafeValReport {
	private String id;
	/**
	 * 使用单位
	 */
	...
	public String getVerifyMedium() {
		return verifyMedium;
	}

	public void setVerifyMedium(String verifyMedium) {
		this.verifyMedium = verifyMedium;
	}
